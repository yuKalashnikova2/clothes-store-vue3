<script setup>
import ToggleItemsList from './ToggleItemsList.vue'
</script>
<template>
    <header class="header">
        <router-link to="/">
        ...
        <ul class="header__details" v-show="$route.path === '/'">
            <router-link to="/">
            ...
            <router-link to="/">
                <li class="header__details__item">Combos</li>
            </router-link>

            <router-link to="/">
                <li class="header__details__item">Joggers</li>
            </router-link>
        </ul>
